...
public class MessageTests
{
    public class MessageToStringMethod
    {
        public static IEnumerable<object[]> MessageData => new[]
        {
            new object[]
            {
                new BeginMessage(BoltProtocolVersion.V4_4, null, Bookmarks.From("bookmark1", "bookmark2"),
            ...
            new object[]
            {
                new RouteMessage(new Dictionary<string, string> {{"RoutingKey", "RoutingValue"}, {"Bob", "Empty"}},
            ...
            new object[]
            {
                new Internal.Messaging.V4_3.RouteMessage(
                    ...
                    Bookmarks.From("bookmark-1"), null),
            ...
            new object[]
            {
                new HelloMessage(BoltProtocolVersion.V4_2, "mydriver", null,
                    new Dictionary<string, string> {{"RoutingKey", "RoutingValue"}}),
            ...
            new object[]
            {
                new HelloMessage(BoltProtocolVersion.V4_1, "mydriver", null,
                    new Dictionary<string, string> {{"RoutingKey", "RoutingValue"}}),
                "HELLO [{user_agent, mydriver}, {routing, [{RoutingKey, RoutingValue}]}]"
            },
            new object[]
            ...
            new object[]
            {
                new RunWithMetadataMessage(
                    ...
                    new Query("A query", new Dictionary<string, object>
                    {
                        {"key1", 1},
                        {"key2", new[] {2, 4}}
                    }), database: "my-database", bookmarks: Bookmarks.From("bookmark-1"),
                    config: TransactionConfig.Default, mode: AccessMode.Read),

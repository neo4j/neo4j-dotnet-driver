    ...
    public class MessageTests
    {
        public class MessageToStringMethod
        {
			...
			public static IEnumerable<object[]> MessageData => new[]
            {
                ...
                new object[] {new V4_2.HelloMessage("mydriver", null, null), "HELLO [{user_agent, mydriver}]"},
                ...
                new object[] {new V4_1.HelloMessage("mydriver", null, null), "HELLO [{user_agent, mydriver}]"},

...
{
    public class ZonedDateTimeHandlerTests : StructHandlerTests
    {
        internal override IPackStreamStructHandler HandlerUnderTest => new ZonedDateTimeHandler();
        ...
        public void ShouldReadDateTimeWithOffset()
        {
            ...
            writer.WriteStructHeader(ZonedDateTimeHandler.StructSize, ZonedDateTimeHandler.StructTypeWithOffset);
        ...
        public void ShouldReadDateTimeWithZoneId()
        {
            ...
            writer.WriteStructHeader(ZonedDateTimeHandler.StructSize, ZonedDateTimeHandler.StructTypeWithId);
            writer.Write(282659759);
            writer.Write(128000987);

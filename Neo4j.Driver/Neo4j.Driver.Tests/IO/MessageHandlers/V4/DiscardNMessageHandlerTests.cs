...
{
    public class DiscardNMessageHandlerTests : StructHandlerTests
    {
        internal override IPackStreamStructHandler HandlerUnderTest => new DiscardNMessageHandler();
        ...
        public void ShouldThrowOnRead()
        {
            ...
            var ex = Record.Exception(() =>
                handler.Read(Mock.Of<IPackStreamReader>(), MsgDiscardN, 0));
        ...
        public void ShouldWriteIdAndN()
        {
            ...
            reader.ReadStructSignature().Should().Be(MsgDiscardN);

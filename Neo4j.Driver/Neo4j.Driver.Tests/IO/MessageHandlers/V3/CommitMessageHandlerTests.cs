...
{
    public class CommitMessageHandlerTests : StructHandlerTests
    {
        internal override IPackStreamStructHandler HandlerUnderTest => new CommitMessageHandler();
        ...
        public void ShouldThrowOnRead()
        {
            ...
            var ex = Record.Exception(() =>
                handler.Read(Mock.Of<IPackStreamReader>(), BoltProtocolV3MessageFormat.MsgCommit, 0));

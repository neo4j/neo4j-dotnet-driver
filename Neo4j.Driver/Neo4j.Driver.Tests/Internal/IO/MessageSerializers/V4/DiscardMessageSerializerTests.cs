    ...
    public class DiscardMessageSerializerTests : PackStreamSerializerTests
    {
        ...
        public void ShouldThrowOnDeserialize()
        {
            ...
            var ex = Record.Exception(() =>
                handler.Deserialize(Mock.Of<IPackStreamReader>(), BoltProtocolV4_0MessageFormat.MsgDiscardN, 0));
        ...
        public void ShouldSerializeIdAndN()
        {
            ...
            reader.ReadStructSignature().Should().Be(BoltProtocolV4_0MessageFormat.MsgDiscardN);

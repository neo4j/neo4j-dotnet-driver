...
{
    public class InitMessageSerializerTests : PackStreamSerializerTests
    {
        internal override IPackStreamSerializer SerializerUnderTest => new InitMessageSerializer();
        ...
        public void ShouldSerialize()
        {
            ...
            reader.ReadStructSignature().Should().Be(BoltProtocolV1MessageFormat.MsgInit);

...
{
    public class RunMessageSerializerTests : PackStreamSerializerTests
    {
        internal override IPackStreamSerializer SerializerUnderTest => new RunMessageSerializer();
        ...
        public void ShouldThrowOnDeserialize()
        {
            ...
            var ex = Record.Exception(() =>
                handler.Deserialize(Mock.Of<IPackStreamReader>(), BoltProtocolV1MessageFormat.MsgRun, 2));
        ...
        [Fact]
        public void ShouldSerializeEmptyMapWhenParamsIsNull()
        {
            var writerMachine = CreateWriterMachine();
            var writer = writerMachine.Writer();

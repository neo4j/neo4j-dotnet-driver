...
namespace Neo4j.Driver.Internal.IO.MessageSerializers.V4_2
{
    public class HelloMessageSerializerTests : PackStreamSerializerTests
    {
        ...
        public void ShouldThrowOnDeserialize()
        {
            ...
            var ex = Record.Exception(() =>
                handler.Deserialize(Mock.Of<IPackStreamReader>(), BoltProtocolV4_2MessageFormat.MsgBegin, 2));
        ...
        public void ShouldSerialize()
        {
            ...
            reader.ReadStructSignature().Should().Be(BoltProtocolV4_2MessageFormat.MsgHello);
        ...
        [Fact]
        public void ShouldNotSerializeWithNullRoutingContext()
        {
            var writerMachine = CreateWriterMachine();
            var writer = writerMachine.Writer();

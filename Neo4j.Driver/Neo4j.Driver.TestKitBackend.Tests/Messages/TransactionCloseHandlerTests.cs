...
public class TransactionCloseHandlerTests
{
    private readonly AutoMocker _autoMocker = AutoMocker.ForTesting<TransactionCloseHandler>();

    [Fact]
    public async Task Closes_the_transaction_and_responds_with_its_id()
    {
        ...
        txMock.Verify(t => t.DisposeAsync(), Times.Once);

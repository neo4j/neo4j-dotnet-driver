...
public class SessionLastBookmarksHandlerTests
{
    private readonly AutoMocker _autoMocker = AutoMocker.ForTesting<SessionLastBookmarksHandler>();

    [Fact]
    public async Task Returns_the_sessions_last_bookmarks()
    {

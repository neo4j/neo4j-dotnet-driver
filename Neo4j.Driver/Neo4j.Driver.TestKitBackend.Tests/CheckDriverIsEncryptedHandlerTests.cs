...
public class CheckDriverIsEncryptedHandlerTests
{
    private readonly AutoMocker _autoMocker = AutoMocker.ForTesting<CheckDriverIsEncryptedHandler>();

    [Fact]
    public async Task Returns_whether_the_driver_is_encrypted()
    {

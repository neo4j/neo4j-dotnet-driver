...
namespace Neo4j.Driver
{
    ...
    /// </summary>
    public interface ISyncSession : ISyncStatementRunner
    {
        /// <summary>
        ...
        ///
        /// All data operations in Neo4j are transactional. However, for convenience we provide a <see cref="ISyncStatementRunner.Run(Statement)"/>
        ...
        /// <returns>A new transaction.</returns>
        ISyncTransaction BeginTransaction(TransactionConfig txConfig);
        ...
        T ReadTransaction<T>(Func<ISyncTransaction, T> work);
        ...
        /// <returns>A result as returned by the given unit of work.</returns>
        T ReadTransaction<T>(Func<ISyncTransaction, T> work, TransactionConfig txConfig);
        ...
        /// <returns>A result as returned by the given unit of work.</returns>
        T WriteTransaction<T>(Func<ISyncTransaction, T> work);
        ...
        /// This configuration overrides server side default transaction configurations. See <see cref="TransactionConfig"/></param>
        /// <returns>A result as returned by the given unit of work.</returns>
        T WriteTransaction<T>(Func<ISyncTransaction, T> work, TransactionConfig txConfig);

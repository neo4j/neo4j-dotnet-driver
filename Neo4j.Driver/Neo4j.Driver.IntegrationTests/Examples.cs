...
namespace Neo4j.Driver.Examples
{
    ...
    public class Examples
    {
        ...
        {
            //tag::minimal-example[]
            using (var driver = GraphDatabase.Driver("bolt+routing://mycluster:7687", AuthTokens.Basic("neo4j", "neo4j")))
        ...
        public void ConstructDriver()
        {
            ...
            var driver = GraphDatabase.Driver("bolt+routing://mycluster:7687", AuthTokens.Basic("neo4j", "neo4j"));
        ...
        public void ConnectWithAuthDisabled()
        {
            ...
            var driver = GraphDatabase.Driver("bolt+routing://mycluster:7687",
                Config.Builder.WithEncryptionLevel(EncryptionLevel.Encrypted).ToConfig());

...
public static class ExperimentalExtensions
{
    ...
    public static IExecutableQuery<IRecord> ExecutableQuery(this IDriver driver, string cypher)
    {
        return new ExecutableQuery<IRecord>((IInternalDriver)driver, cypher);
    }

...
{
    /// <summary>
    /// Preview: Bookmark Manager API is still under consideration. <br/> There is no guarantee that anything in
    /// Neo4j.Driver.Preview namespace will be in a next minor version.<br/> Gets a new
    ...
    /// session with <see cref="PreviewExtensions.WithBookmarkManager"/>.
    /// </summary>

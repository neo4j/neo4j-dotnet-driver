...
public sealed class SessionConfig
{
    ...
    /// <summary>
    /// Configuration for which <see cref="INotification"/>s the server will
    /// return in <see cref="IResultSummary.Notifications"/> when executing queries.
...
public sealed class SessionConfigBuilder
{
    ...
    /// <exception cref="InvalidOperationException">When either <see cref="WithServerDefaultNotifications"/>
    ///  or <see cref="WithNoNotifications"/> was called previously on <see cref="SessionConfigBuilder"/> instance.</exception>
    ...
    public SessionConfigBuilder WithNotificationFilters((Severity, Category)[] filters)
    {
        if (filters is null)
    ...
    /// <summary>
    /// Set session to receive any <see cref="INotification"/>s in <see cref="IResultSummary.Notifications"/>
    /// when executing queries using server configuration.
    /// Overriding any driver configuration for queries executed in the session.
    /// </summary>
    /// <remarks>Cannot be used with either: <see cref="WithNotificationFilters"/>, <see cref="WithNoNotifications"/>.</remarks>
    /// <exception cref="InvalidOperationException">When either <see cref="WithNotificationFilters"/> or
    /// <see cref="WithNoNotifications"/> was called previously on <see cref="SessionConfigBuilder"/> instance.</exception>
    /// <returns>A <see cref="SessionConfigBuilder"/> instance for further configuration options.</returns>
    public SessionConfigBuilder WithServerDefaultNotifications()
    {
    ...
    /// Overriding any driver configuration for queries executed in the session.
    /// </summary>
    /// <remarks>Cannot be used with either: <see cref="WithNotificationFilters"/>, <see cref="WithServerDefaultNotifications"/>.</remarks>
    /// <exception cref="InvalidOperationException">When either <see cref="WithNotificationFilters"/> or
    /// <see cref="WithServerDefaultNotifications"/> was called previously on <see cref="SessionConfigBuilder"/> instance.</exception>
    /// <returns>A <see cref="SessionConfigBuilder"/> instance for further configuration options.</returns>

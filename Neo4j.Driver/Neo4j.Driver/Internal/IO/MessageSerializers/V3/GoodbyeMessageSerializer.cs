...
{
    internal class GoodbyeMessageSerializer : WriteOnlySerializer
    {
        public override IEnumerable<Type> WritableTypes => new[] {typeof(GoodbyeMessage)};

        public override void Serialize(IPackStreamWriter writer, object value)
        {
            writer.WriteStructHeader(0, MsgGoodbye);
        }
    }
}
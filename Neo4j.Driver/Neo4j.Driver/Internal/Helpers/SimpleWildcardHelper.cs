...
{
    /// <summary>
    /// Returns true if the two strings are the same, or, if <paramref name="y"/> ends with an asterisk (*), returns
    /// true if <paramref name="x"/> starts with <paramref name="y"/> (minus the asterisk).
    /// </summary>

...
internal class KerberosAuthToken : AuthToken
{
    ...
    public string Ticket => Content[CredentialsKey] as string;

    public override string ToString()
    {
        return $"KerberosAuthToken[scheme: {Scheme}, ticket: {Ticket.Substring(0, 5)}...]";
    }
}

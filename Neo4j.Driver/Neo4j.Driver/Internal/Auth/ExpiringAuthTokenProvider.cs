...
internal class ExpiringAuthTokenProvider : IExpiringAuthTokenProvider
{
    private readonly Func<Task<AuthTokenAndExpiration>> _tokenProviderAsync;

    public ExpiringAuthTokenProvider(Func<Task<AuthTokenAndExpiration>> tokenProviderAsync)
    {

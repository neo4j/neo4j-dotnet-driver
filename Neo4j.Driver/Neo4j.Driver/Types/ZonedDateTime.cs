...
/// </summary>
public sealed class ZonedDateTime : TemporalValue, IEquatable<ZonedDateTime>, IComparable, IComparable<ZonedDateTime>,
    IHasDateTimeComponents
{
    ...
    public enum AmbiguityReason
    {
        ...
        None,
        /// <summary>
        ///     The lookup of the offset will be completed with a local time which may result an ambiguous value.
        /// </summary>
        ZoneIdLookUpWithLocalTime,
        /// <summary>
        ///     The datetime kind is unspecified, it will be treated as local time.
        /// </summary>
        UnspecifiedDateTimeKind,
        /// <summary>
        ///     The lookup of the offset will be completed with a value truncated to the range of CLR types meaning that
        ///     any rules that may apply outside of the CLR ranges are not applied.
        /// </summary>
    ...
    /// <summary>
    ///     Reason why this instance is could be ambiguous.
    /// </summary>
    ...
    /// <summary>
    ///     Gets the number of seconds since the Unix Epoch (00:00:00 UTC, Thursday, 1 January 1970). <br/>
    ///     Introduced in 4.4.1 a fix to a long standing issue of not having a monotonic datetime used on construction
    ///     or transmission.
    /// </summary>
    ...
    /// <summary>
    ///     Gets a <see cref="DateTime" /> value that represents the local date and time of this instance.
    /// </summary>
    ...
    /// <summary>
    ///     Gets a <see cref="DateTime" /> the UTC value that represents the date and time of this instance.
    /// </summary>
    /// <exception cref="ValueOverflowException">If the value cannot be represented with DateTime</exception>
    /// <exception cref="ValueTruncationException">If a truncation occurs during conversion</exception>
    ...
    /// <returns>
    ///     <code>true</code> if the <code>value</code> parameter equals the value of
    ...
    private DateTime ClrFriendly(LocalDateTime local)
    {
        ...
        return new DateTime(year, local.Month, local.Day, local.Hour, local.Minute,
    ...
    /// <returns>
    ///     <code>true</code> if <code>value</code> is an instance of <see cref="ZonedDateTime" /> and
    ///     equals the value of this instance; otherwise, <code>false</code>
    /// </returns>

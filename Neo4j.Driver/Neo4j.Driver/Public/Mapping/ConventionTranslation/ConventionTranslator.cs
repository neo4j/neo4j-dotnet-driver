...
public class ConventionTranslator(ITokenExtractor objectTokenExtractor, ITokenCombiner recordTokenCombiner)
    : IConventionTranslator
{
    /// <inheritdoc />
    public string Translate(string input)
    {
        var extractedTokens = objectTokenExtractor.ExtractTokens(input);
        var recombinedText = recordTokenCombiner.CombineTokens(extractedTokens);

...
/// </summary>
/// <remarks>
/// Calling <see cref="ResultCursorExtensions.ToListAsync(IResultCursor, CancellationToken)"/> will enumerate the
/// entire stream.
/// </remarks>
public interface IResultCursor : IAsyncEnumerable<IRecord>
{
    ...
    /// using <see cref="ResultCursorExtensions.ToListAsync(IResultCursor, CancellationToken)"/>. If all records in the records
    /// stream are already consumed, then this method will return the summary directly.
    /// </summary>

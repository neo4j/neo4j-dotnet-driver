...
public static class GraphDatabase
{
        ...
        ConnectionSettings connectionSettings)
    {
        ...
        var connectionProvider = parsedUri.IsRoutingUri()
            ? new LoadBalancer(connectionFactory, routingSettings, connectionPoolSettings, logger, config.NotificationsConfig)
            : new ConnectionPool(parsedUri, connectionFactory, connectionPoolSettings, logger, null, config.NotificationsConfig) as
                IConnectionProvider;

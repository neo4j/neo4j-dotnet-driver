...
public sealed class ConfigBuilder
{
    ...
    /// <summary>
    /// Builds the <see cref="Config"/> instance based on the previously internal set values.
    /// </summary>
    /// <remarks>>
    /// If no value was internal set for a property the defaults specified in <see cref="Config"/> will be used.
    /// </remarks>
    ...
    ///  or <see cref="WithNoNotifications"/> was called previously on <see cref="ConfigBuilder"/> instance.</exception>
    ...
    /// <summary>
    /// Set driver to receive any <see cref="INotification"/>s in <see cref="IResultSummary.Notifications"/>
    ...
    /// <see cref="WithNoNotifications"/> was called previously on <see cref="ConfigBuilder"/> instance.</exception>
    /// <returns>A <see cref="ConfigBuilder"/> instance for further configuration options.</returns>
    ...
    /// <summary>
    /// Set driver to not receive <see cref="INotification"/>s from the server when executing queries.
    /// </summary>
    /// <remarks>Cannot be used with either: <see cref="WithNotificationFilters"/>, <see cref="WithServerDefaultNotifications"/>.</remarks>
    /// <exception cref="InvalidOperationException">When either <see cref="WithNotificationFilters"/> or
    /// <see cref="WithServerDefaultNotifications"/> was called previously on <see cref="ConfigBuilder"/> instance.</exception>
    /// <returns>A <see cref="ConfigBuilder"/> instance for further configuration options.</returns>

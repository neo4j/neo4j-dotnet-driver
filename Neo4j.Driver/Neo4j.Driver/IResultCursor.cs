...
public interface IResultCursor
{
    ...
    /// <summary>
    /// Get whether the cursor is open to read records, a cursor will be considered open if
    /// <see cref="ConsumeAsync" /> has not been called.<br /> Attempting to read records from a closed cursor will throw
    ...
    /// using <see cref="ResultCursorExtensions.ToListAsync" />. If all records in the records stream are already consumed,

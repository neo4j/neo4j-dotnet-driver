...
internal record BookmarksConsumerRequest(
    ...
    string[] Bookmarks) : IProtocolMessage;

internal record BookmarksConsumerCompletedRequest : IProtocolMessage
{
...
internal class BookmarksConsumerCompletedHandler : MessageHandler<BookmarksConsumerCompletedRequest>
{
    private readonly IContinuationCoordinator _coordinator;
    private readonly IResponseWriter _responseWriter;

    public BookmarksConsumerCompletedHandler(
    ...
    public override async Task ProcessAsync(BookmarksConsumerCompletedRequest message)
    {

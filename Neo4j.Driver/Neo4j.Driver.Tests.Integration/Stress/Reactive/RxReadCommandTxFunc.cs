...
{
	public class RxReadCommandTxFunc<TContext> : RxCommand<TContext>
		where TContext : StressTestContext
	{
		public RxReadCommandTxFunc(IDriver driver, bool useBookmark)
		...
		public override async Task ExecuteAsync(TContext context)
		{
			...
			var summary = await session.ReadTransaction(txc =>
				{
